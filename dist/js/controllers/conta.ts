...
import abreAside from "../utils/abreAside.js"
    ...
    const campoUsuario = document.getElementById('usuario')as HTMLInputElement
    ...
    const campoSenha1 = document.getElementById('campo-senha1')as HTMLInputElement
    ...
    const fotoPerfil = document.getElementById('foto-perfil') as any
    const primeiroNomeInput = document.getElementById('primeiroNome') as HTMLInputElement
    const segundoNomeInput = document.getElementById('segundoNome') as HTMLInputElement
    ...
    const numeroBancoInput = document.getElementById('numeroBanco') as HTMLInputElement
    ...
    abreAside()
    function refazClassInput(campo: HTMLElement, resultado: boolean){
        if (resultado){
