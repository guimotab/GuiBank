...
import abreAside from "../utils/abreAside.js";
    ...
    const inputDepositar = document.getElementById('input-depositar') as HTMLInputElement

    const formularioSacar = document.getElementById('formulario-sacar')!
    const inputSacar = document.getElementById('input-sacar') as HTMLInputElement
    ...
    function blurInputs(tipoInput: HTMLInputElement, classInput: HTMLElement) {
